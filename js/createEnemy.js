function createEnemy(allTiles) {
    ...
    if (randomEnemy == enemyList.indexOf('rat')) {
        ...
        return rat = new Creature('rat', houses[randomHouse].offsetLeft / 10, houses[randomHouse].offsetTop / 10, houses[randomHouse].offsetWidth / 10, houses[randomHouse].offsetHeight / 10);
    };
};